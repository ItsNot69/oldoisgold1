...
class Config(object):
    ...
    MONGO_DB_URI = os.environ.get("MONGO_DB_URI", "mongodb+srv://m0921594:Rohit99@cluster0.gwuslet.mongodb.net/?retryWrites=true&w=majority")
